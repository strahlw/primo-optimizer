...
# stagedfright was originally developed as part of the PARETO project
...
def main(args: Optional[List[str]] = None) -> int:
    ...
    try:
        ...
        _logger.critical("Could not determine staged files for this repository.")
        return notify_exit(ExitCode.internal_error)
    else:
    ...
    if not staged_paths:
        _logger.warning("No staged files detected.")
